...
module cpu_top #(
    ...
    logic signed [31:0] s_imm_I, s_imm_S, s_imm_B, s_imm_U, s_imm_J;
    ...
    assign ecall_sel = reg_data1[0]; // based on register x17, determine it's putchar or getchar
    ...
    writeback_mux u_writeback_mux (
        ...
        .normal_writeback_data(normal_writeback_data),
